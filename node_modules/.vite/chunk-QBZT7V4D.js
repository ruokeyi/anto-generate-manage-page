...
function avoidOverlap(labelLayoutList, cx, cy, r, viewWidth, viewHeight, viewLeft, viewTop) {
  ...
  for (var i = 0; i < labelLayoutList.length; i++) {
    ...
    if (!isPositionCenter(layout8) && layout8.linePoints) {
      if (layout8.labelStyleWidth != null) {
        continue;
      }
      ...
      } else if (layout8.labelAlignTo === "labelLine") {
        if (label.x < cx) {
          targetTextWidth = leftmostX - viewLeft - layout8.bleedMargin;
        } else {
          targetTextWidth = viewLeft + viewWidth - rightmostX - layout8.bleedMargin;
        }
      } else {
        if (label.x < cx) {
      ...
      layout8.targetTextWidth = targetTextWidth;
      constrainTextWidth(layout8, targetTextWidth);
    }
  }
  ...
  for (var i = 0; i < labelLayoutList.length; i++) {
    ...
    if (!isPositionCenter(layout8) && layout8.linePoints) {
      ...
      var realTextWidth = layout8.rect.width + extraPaddingH;
...
function constrainTextWidth(layout8, availableWidth, forceRecalculate) {
  ...
  if (availableWidth < oldOuterWidth || forceRecalculate) {
    ...
    if (overflow && overflow.match("break")) {
      ...
      var newWidth = availableWidth < oldOuterWidth ? availableInnerWidth : forceRecalculate ? availableInnerWidth > layout8.unconstrainedWidth ? null : availableInnerWidth : null;
    ...
    each(DISPLAY_STATES, function(stateName) {
      ...
      if (labelPosition === "outside") {
        ...
        if (!textAlign || textAlign === "center") {
          if (angle === 2 * Math.PI && layout8.r0 === 0) {
            r = 0;
          } else {
...
//# sourceMappingURL=chunk-QBZT7V4D.js.map
