    ...
    (function() {
      var media = function() {
        ...
        var matchPattern = function(url) {
          var pattern = urlPatterns.filter(function(pattern2) {
            return pattern2.regex.test(url);
          });
          if (pattern.length > 0) {
        ...
        var register = function(editor) {
          ...
          editor.addCommand("mceMedia", showDialog2);
        };
...
// dep:tinymce_plugins_media_index
var tinymce_plugins_media_index_default = require_media();
export {
  tinymce_plugins_media_index_default as default
};
//# sourceMappingURL=tinymce_plugins_media_index.js.map
