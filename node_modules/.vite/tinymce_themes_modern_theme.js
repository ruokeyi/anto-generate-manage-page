      ...
      var modern = function(domGlobals) {
        ...
        var proto$1 = {
          ...
          repaint: function() {
            ...
            if (rect.x !== lastRepaintRect.x) {
              style.left = round2(rect.x) + "px";
              lastRepaintRect.x = rect.x;
            }
            if (rect.y !== lastRepaintRect.y) {
              style.top = round2(rect.y) + "px";
              lastRepaintRect.y = rect.y;
            }
            if (rect.w !== lastRepaintRect.w) {
              value = round2(rect.w - borderW);
              style.width = (value >= 0 ? value : 0) + "px";
              lastRepaintRect.w = rect.w;
            }
            if (rect.h !== lastRepaintRect.h) {
              value = round2(rect.h - borderH);
              style.height = (value >= 0 ? value : 0) + "px";
              lastRepaintRect.h = rect.h;
            }
            if (self._hasBody && rect.innerW !== lastRepaintRect.innerW) {
              value = round2(rect.innerW);
        ...
        function Throbber(elm, inline) {
          ...
          self.show = function(time, callback) {
            function render2() {
              if (state) {
                global$9(elm).append('<div class="' + classPrefix2 + "throbber" + (inline ? " " + classPrefix2 + "throbber-inline" : "") + '"></div>');
                if (callback) {
                  callback();
                }
              }
              ...
              global$9(domGlobals.window).on("resize", function() {
                ...
                if (self._fullscreen) {
                  if (!slowRendering) {
                    ...
                    self.moveTo(0, 0).resizeTo(rect2.w, rect2.h);
                    ...
                    if (!self._timer) {
                      self._timer = global$7.setTimeout(function() {
                        ...
                        self.moveTo(0, 0).resizeTo(rect3.w, rect3.h);
                        self._timer = 0;
                      }, 50);
                    }
                  }
        ...
        function WindowManagerImpl(editor) {
          ...
          var setParams = function(window2, params) {
            window2.params = params;
          };
          return {
            open,
            alert,
              ...
              if (fileBrowserCallback && (!fileBrowserCallbackTypes || fileBrowserCallbackTypes[fileType])) {
                actionCallback = function() {
                  ...
                  fileBrowserCallback.call(editor, function(value, meta2) {
                    self.value(value).fire("change", { meta: meta2 });
                  }, self.value(), meta);
                };
              } else {
        ...
        var createFormatMenu = function(editor) {
          ...
          var createMenu2 = function(formats) {
            ...
            global$2.each(formats, function(format) {
              ...
              if (format.items) {
                menuItem.menu = createMenu2(format.items);
              } else {
                var formatName = format.format || "custom" + count2++;
                if (!format.format) {
          ...
          return function() {
            ...
            editor.on("nodeChange", function(e) {
              ...
              global$2.each(e.parents, function(node2) {
                global$2.each(items, function(item) {
                  if (formatName) {
                    if (formatter.matchNode(node2, formatName, { value: item.value })) {
                      value = item.value;
                    }
                  } else {
        ...
        var MenuItem = Widget.extend({
          ...
          renderHtml: function() {
            ...
            function markMatches(text2) {
              var match = settings.match || "";
              return match ? text2.replace(new RegExp(escapeRegExp(match), "gi"), function(match2) {
                return "!mce~match[" + match2 + "]mce~match!";
              }) : text2;
            }
            function boldMatches(text2) {
              return text2.replace(new RegExp(escapeRegExp("!mce~match["), "g"), "<b>").replace(new RegExp(escapeRegExp("]mce~match!"), "g"), "</b>");
            }
            if (icon) {
          ...
          postRender: function() {
            ...
            function handleKeyboard(minValue2, maxValue2) {
              function alter(delta) {
                var value;
                value = self.value();
                value = fromFraction(minValue2, maxValue2, toFraction(minValue2, maxValue2, value) + delta * 0.05);
            ...
            function handleDrag(minValue2, maxValue2, handleEl) {
...
// dep:tinymce_themes_modern_theme
var tinymce_themes_modern_theme_default = require_theme();
export {
  tinymce_themes_modern_theme_default as default
};
//# sourceMappingURL=tinymce_themes_modern_theme.js.map
