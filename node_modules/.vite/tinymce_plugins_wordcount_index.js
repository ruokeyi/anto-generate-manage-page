  ...
  "node_modules/tinymce/plugins/wordcount/plugin.js"() {
    (function() {
      var wordcount = function() {
        ...
        var WordBoundary = { isWordBoundary };
        ...
        var doGetWords = function(str, options) {
          var i = 0;
          var map2 = StringMapper.classify(str);
          var len = map2.length;
          var word = [];
          var words = [];
          var chr;
          ...
          for (; i < len; ++i) {
            chr = str.charAt(i);
            word.push(chr);
            if (WordBoundary.isWordBoundary(map2, i)) {
        ...
        var WordGetter = { getWords };
        var getText = function(node, schema) {
          var blockElements = schema.getBlockElements();
          var shortEndedElements = schema.getShortEndedElements();
          var whiteSpaceElements = schema.getWhiteSpaceElements();
          var isSeparator = function(node2) {
            return blockElements[node2.nodeName] || shortEndedElements[node2.nodeName] || whiteSpaceElements[node2.nodeName];
          };
          var txt = "";
        ...
        var setup = function(editor) {
          var wordsToText = function(editor2) {
            return global$4.translate([
              "{0} words",
              WordCount.getCount(editor2)
            ]);
          };
          var update = function() {
...
// dep:tinymce_plugins_wordcount_index
var tinymce_plugins_wordcount_index_default = require_wordcount();
export {
  tinymce_plugins_wordcount_index_default as default
};
//# sourceMappingURL=tinymce_plugins_wordcount_index.js.map
