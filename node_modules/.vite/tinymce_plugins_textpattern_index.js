      ...
      var textpattern = function(domGlobals) {
        ...
        var findEndPattern = function(patterns, text, offset, delta) {
          ...
          for (i = 0; i < patterns.length; i++) {
            pattern = patterns[i];
            if (pattern.end !== void 0 && isMatchingPattern(pattern, text, offset, delta) && hasContent(offset, delta, pattern)) {
              return pattern;
            }
          }
        };
        var findInlinePattern = function(patterns, rng, space) {
          ...
          if (endPattern === void 0 || startPattern !== endPattern || container.data.length <= endPattern.start.length + endPattern.end.length) {
            return;
          }
          return {
            pattern: endPattern,
        ...
        var checkKeyCode = function(codes, event) {
          return checkKeyEvent(codes, event, function(code, event2) {
            return code === event2.keyCode && global$2.modifierPressed(event2) === false;
          });
        };
...
// dep:tinymce_plugins_textpattern_index
var tinymce_plugins_textpattern_index_default = require_textpattern();
export {
  tinymce_plugins_textpattern_index_default as default
};
//# sourceMappingURL=tinymce_plugins_textpattern_index.js.map
