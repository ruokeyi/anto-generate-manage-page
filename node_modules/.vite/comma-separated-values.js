...
var require_csv = __commonJS({
  "node_modules/comma-separated-values/csv.js"(exports, module) {
    (function(root, factory) {
      ...
      "use strict";
      var ESCAPE_DELIMITERS = ["|", "^"], CELL_DELIMITERS = [",", ";", "	", "|", "^"], LINE_DELIMITERS = ["\r\n", "\r", "\n"];
      ...
      function fallback(value, fallback2) {
        return isPresent(value) ? value : fallback2;
      }
      ...
      var CSV = function() {
        ...
        CSV2.prototype.set = function(setting, value) {
          return this.options[setting] = value;
        };
        CSV2.prototype.isParser = function() {
          return this.mode == "parse";
        };
        CSV2.prototype.isEncoder = function() {
          return this.mode == "encode";
        };
        CSV2.prototype.parse = function(callback) {
          if (this.mode != "parse")
            return;
          if (this.data.trim().length === 0)
            return [];
          var data = this.data, options = this.options, header = options.header, current = { cell: "", line: [] }, deserialize = this.deserialize, flag, record, response;
          if (!callback) {
            response = [];
            callback = function(record2) {
              response.push(record2);
            };
          }
          function resetFlags() {
          ...
          var dataLength = data.length, cellDelimiter = options.cellDelimiter.charCodeAt(0), lineDelimiter = options.lineDelimiter.charCodeAt(options.lineDelimiter.length - 1), _i, _c, _ch;
          resetFlags();
        ...
        CSV2.prototype.serialize = {
          "object": function(object) {
            var that = this, attributes = Object.keys(object), serialized = Array(attributes.length);
          ...
          "array": function(array) {
            var that = this, serialized = Array(array.length);
        ...
        CSV2.prototype.encode = function(callback) {
          if (this.mode != "encode")
            return;
          if (this.data.length == 0)
            return "";
          var data = this.data, options = this.options, header = options.header, sample = data[0], serialize = this.serialize, offset = 0, attributes, response;
          if (!callback) {
        ...
        CSV2.prototype.forEach = function(callback) {
...
// dep:comma-separated-values
var comma_separated_values_default = require_csv();
export {
  comma_separated_values_default as default
};
//# sourceMappingURL=comma-separated-values.js.map
