...
var P = defineComponent({ name: "VueCodemirror", props: Object.assign({}, w), emits: Object.assign({}, F), setup: function(t2, s) {
  var f = shallowRef(), d = shallowRef(), C3 = shallowRef(), D2 = Object.assign(Object.assign({}, h2), inject(y, {})), U2 = computed(function() {
    ...
    return Object.keys(toRaw(t2)).forEach(function(n) {
      var o;
      n !== "modelValue" && (e[n] = (o = t2[n]) !== null && o !== void 0 ? o : D2[n]);
    }), e;
  });
  return onMounted(function() {
    var e;
    d.value = j({ doc: t2.modelValue, selection: U2.value.selection, extensions: (e = D2.extensions) !== null && e !== void 0 ? e : [], onFocus: function(e2) {
    ...
    var n = function(e2) {
      ...
      return { focus: function() {
        ...
        e3 === void 0 && (e3 = {}), c(EditorView.theme({ "&": Object.assign({}, e3) }));
      } };
    }(C3.value);
    watch(function() {
