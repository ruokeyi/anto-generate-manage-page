    ...
    (function() {
      var spellchecker = function(domGlobals) {
        ...
        var get = function(editor, startedState, lastSuggestionsState, textMatcherState, currentLanguageState, url) {
          ...
          var markErrors2 = function(data) {
            Actions.markErrors(editor, startedState, textMatcherState, lastSuggestionsState, data);
          };
          var getTextMatcher2 = function() {
            return textMatcherState.get();
          };
          return {
            getTextMatcher: getTextMatcher2,
            getWordCharPattern,
            markErrors: markErrors2,
...
// dep:tinymce_plugins_spellchecker_index
var tinymce_plugins_spellchecker_index_default = require_spellchecker();
export {
  tinymce_plugins_spellchecker_index_default as default
};
//# sourceMappingURL=tinymce_plugins_spellchecker_index.js.map
